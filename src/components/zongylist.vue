<template>
	...
	<div class="list">
		<div class="item" v-for="goods in goodslist" :key="goods.id">
			<div class="item-l">
				<img class="item-img" :src="goods.zongyimg">
				<video :src="goods.zongyV" class="video-js" controls :poster="goods.zy"></video>
			</div>
			<div class="item-r">
				<div class="item-title">{{goods.zongyname }}</div>
				<div class="item-desc">{{goods.zongydesc}}</div>
