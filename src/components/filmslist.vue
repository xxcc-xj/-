<template>
	...
	<div class="list">
		<div class="item" v-for="goods in goodslist" :key="goods.id">
			<div class="item-l">
				<img class="item-img" :src="goods.filmimg">
				<video :src="goods.filnV" class="video-js" controls :poster="goods.film"></video>
			</div>
			<div class="item-r">
				<div class="item-title">{{goods.filmname }}</div>
				<div class="item-desc">{{goods.filmdesc}}</div>
