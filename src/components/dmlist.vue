<template>
	...
	<div class="list">
		<div class="item" v-for="goods in goodslist" :key="goods.id">
			<div class="item-l">
				<img class="item-img" :src="goods.dmimg">
				<video :src="goods.dmV" class="video-js" controls :poster="goods.dm"></video>
			</div>
			<div class="item-r">
				<div class="item-title">{{goods.dmname }}</div>
				<div class="item-desc">{{goods.dmdesc}}</div>
				<div class="item-opt">
